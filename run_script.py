...
#Train
if num_epochs != 0:
	Net.run_batch(training_vectors, training_labels, hmm_alg=alg, frac_vertical=frac_vertical, batch_size=batch_size, num_epochs=num_epochs, init_file=init_file, saver_prefix=saver_prefix);

if num_epochs == 0:
	Net.run_batch(training_vectors, training_labels, hmm_alg=alg, frac_vertical=frac_vertical, batch_size=batch_size, num_epochs=0, init_file=init_file, saver_prefix=saver_prefix, test_vectors=training_vectors, test_labels=training_labels);
